...
When we look at the common understanding of 'play' over the last hundred years, we see a few consistent themes. We may think of it in terms of its entertainment qualities - as in video games, professional sports, and game shows. We may look down on it as a non-serious activity reserved for children with their playground antics and silly role-playing. Even the first serious researchers of play softened their language on the importance of play, with Huizinga famously claiming that play was "not serious" and "no profit can be gained by it," and Roger Caillois similarly stating that it was 'unproductive.' It is as if these early sociologists were downplaying the impact of play, perhaps thinking that studying play was an embarrassment.

At the turn of the twenty-first century, a more dedicated field of game studies arose that took games more seriously but focused on a particular area of impact. The 'serious games' and 'games for change' movements believed that games and play were meaningful primarily as a way to bring positive change to the world, perhaps most famously in Jane McGonigal's 2010 Ted talk entitled "[Gaming can make a better world](https://www.ted.com/talks/jane_mcgonigal_gaming_can_make_a_better_world?language=en)." In her introduction to _Woke Gaming_ Kishonna L. Gray explains how game designers such as Anna Anthropy

_"have sought to tear down the walls of the hegemony of gaming and demand equity in each and every space. They demonstrate the potential of games as teachers of alternative narratives and histories, as challenges to the ideologies of hate, persistent inequalities, and violent injustice. They model the possibility of games giving voice to the experiences, (intersectional) identities, and histories of otherwise marginalized and erased communities."_ (8)

While this understanding of the potential of games is noteworthy and ultimately effective in its stated goals, it is often rooted primarily in the persuasive storytelling functionality of games, using immersive world-building and narration to present different worldviews to the player. This focus seems to ignore the potential for games to be meaningful as an art form on their own merit.

By widening our circle of focus from games specifically, we can begin to develop an interesting groundwork with which to think about the potentials of _play_ as an art form in itself. Game designers and researchers like Bernie DeKoven, Miguel Sicart, and Frank Lantz believe that this wider field of play provides an opportunity to explore fundamental aspects of human existence. In his book _Play Matters_, Sicart claims that "[t]o play is to be in the world. Playing is a form of understanding what surrounds us and who we are, and a way of engaging with others. Play is a mode of being human." Play is a lens that shows us truth in the world, and deeper still, there are facets or angles within that lens that we can use to examine particular aspects of play. Borrowing from Sicart and also leaning on Theodor Ardano's concept of Aesthetic Theory, I propose four key aesthetic components of play as Player(s), Playthings, Playgrounds, and Playtime. These are in no way a concrete classification to analyze all playful activities, but rather, a simple framework with which to reflect on the nature of play. The question then becomes, "Well, what can we _do_ with play?"

Contemporary society has created a situation in which people feel overwhelmed, with fractured attention and the pressure to be continually active and productive. Jenny O'Dell is a key voice in this movement, publishing books such as "How to do Nothing" and "Saving Time," but many others have noted the pull to have a more meaningful relationship with the world than what the design of our technologies seems to dictate. We act and act, without giving ourselves time to reflect, to contemplate on the nature of the world. In the past, art has fulfilled this purpose. The paintings in our museums, the music in our recital halls, and the stories in our literature would give us opportunities for this contemplation. Yet now, even our leisure time is full of activity and over-stimulation. Philosopher Byung-Chul Han laments this state of being, and advocates for stepping away from a life of pure activity, stating "we owe true happiness to the useless and purposeless, to what is intentionally convoluted, what is unproductive, indirect, exuberant, superfluous, to beautiful forms and gestures that have no use and serve no purpose." He names this concept "ceremonious inactivity" where "we do something, but to no end." Is there a better category for which to place 'play' than 'ceremonious inactivity?'

Using play as this 'ceremonious inactivity,' we can focus on an aesthetic of 'contemplative play,' a play with the potential to more clearly show the nature of the world around us, and who we are within that world. Play can be more than just entertainment or a tool of persuasion. The functionality of play, the nimble maneuvering of people together within a system, is a unique form of meaning-making that, in an age of fractured attention and instrumentalized leisure, offers a compelling alternative: a space of purposeless engagement where we encounter ourselves, others, and the world afresh. Where serious games try to guide the player to challenge the status quo and appreciate defined alternative narratives, contemplative play guides the player toward an openness that provides the opportunity for introspection at a deeper, undefined level. Through the lenses of Players, Playthings, Playgrounds, and Playtime — and in dialogue with disciplines like soundwalks and deep listening practices, performative objects, contemplative architecture, and ambient media — we can cultivate a deeper, more reflective mode of interacting with the world. This is not play as escape, but play as encounter.
