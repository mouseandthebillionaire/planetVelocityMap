...
The playtests with these designers will be a mix of informal in-person observed playtests and remote playtests where I am not present. For both of these types of playtests, I will ask the participants to give me as detailed feedback as they can, whether verbally or in writing. The purpose of these feedback sessions is to get the unvarnished reactions of the prototypes by those familiar with the field and immediately loop it back into the iterative design process detailed in the previous section. 

One problematic issue that may arise here is that not everyone who is familiar with the field of game design will also be an expert in sound design. They may understand what makes a successful game, but not necessarily how sound is best leveraged in that design. Likewise, it is also true that many who are familiar with sound design may not be as familiar with how that particular discipline is used in games. Additionally, even for those who are experts in both fields, there is often not a common way to discuss and evaluate what we are listening to.

To help facilitate these conversations and to set a common language for the dialogue, I will use the Sound Experience model developed by Ruth Sørensen at IT-University of Copenhagen. In this model, Sørensen introduces a visual aid to help evaluators think about the different modes of listening that happen in any given experience. Listeners are made aware that for any sound there are both external and internal contexts. External contexts include physical ideas such as space and time along with non-physical contexts such as the social and cultural space affecting how the sound may be perceived by the listener. Internal contexts, or those contexts that a listener brings with themselves to the listening experience, are hearing capabilities, historical background, anticipation, and prior experiences. Once this foundational and contextual understanding is established the sound itself can then be addressed and evaluated in four specific areas: emotion, meaning, time, and environment. While not necessarily directly applicable for this particular research, Sørensen also introduces the idea of listening focus, where we can think about where a listener is situated on a spectrum ranging from inattentive to immersed. In general, this model and accompanying visual aid will help to create meaningful discourse with these prototypes to learn more accurately what is and what is not working.
...
Could these be paired with more concrete 'Game' elements? Space + gameworlds? / Physicality + Game Performance/Embodiment / Materiality + Alt control / Time + (What?)

QUESTION: in rereading Miguel's _Play Matters_, I was struck by his use of plaything in place of where we're using "object" or "material" or "stuff" here. This also beings to mind PLAY+ as a framework for all of these. Playspace / Playtime / Player / Plaything. I'm not in *Iove* in love with this, but it does feel like an interesting concept for thinking about them.
